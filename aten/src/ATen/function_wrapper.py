        ...
        for option in declaration['options']:
            ...
            try:
                if option['mode'] != 'native':
                    ...
                    #print('\n\n [iuriiz_3]', declaration['name']) # empty goes here
...
def create_generic2(declarations):
    ...
    def process_native(option):
        ...
        a = any(arg['type'] == 'c10::optional<ScalarType>' for arg in option['arguments']) and any(arg['type'] == 'c10::optional<Layout>' for arg in option['arguments']) and any(arg['type'] == 'c10::optional<Device>' for arg in option['arguments']) and any(arg['type'] == 'c10::optional<bool>' for arg in option['arguments'])
        b = any(arg['type'] == 'ScalarType' for arg in option['arguments']) and any(arg['type'] == 'Layout' for arg in option['arguments']) and any(arg['type'] == 'Device' for arg in option['arguments']) and any(arg['type'] == 'bool' for arg in option['arguments'])
        a1 = any(arg['type'] == 'c10::optional<at::ScalarType>' for arg in option['arguments']) and any(arg['type'] == 'c10::optional<at::Layout>' for arg in option['arguments']) and any(arg['type'] == 'c10::optional<at::Device>' for arg in option['arguments']) and any(arg['type'] == 'c10::optional<bool>' for arg in option['arguments'])
        b1 = any(arg['type'] == 'at::ScalarType' for arg in option['arguments']) and any(arg['type'] == 'at::Layout' for arg in option['arguments']) and any(arg['type'] == 'at::Device' for arg in option['arguments']) and any(arg['type'] == 'bool' for arg in option['arguments'])

        is_factory_method = a or a1 or b1 or b
